...
<h4 class="text-center" style="color:green"> Billing Page </h4>
<div class="row">
...
?>
<option id="<?php echo $row['id']; ?>" value="<?php echo $row['P_Type']; ?>" class="vegitable custom-select">
<?php echo $row['P_Type']; ?>
</option>
<?php  }?>
</select>
...
<div class="col-md-6  mt-4" style="background-color:#f5f5f5;">
<div class="p-4">
